...
gaussopt=[[1,v0,mu_g]]
phys_params = (;hbar=1.0,mur,vint_arr=[v_coulomb],lmax=0,lmin=0,dim=3)
...
energies_arr1a = GEM2B.GEM_solve(phys_params,num_params;wf_bool=0,cr_bool=0,csm_bool=0)
...
energies_arr1c = GEM2B.GEM_solve(phys_params,num_params;wf_bool=0,cr_bool=1,csm_bool=0)
comparison(energies_arr1c)

#2. Does  csm_bool = 1, theta_csm = 0.0 recover the old results?
println("\n2) csm_bool = 1, theta_csm = 0.0:")
energies_arr2 = GEM2B.GEM_solve(phys_params,num_params;wf_bool=0,cr_bool=0,csm_bool=1)
...
energies_arr3 = GEM2B.GEM_solve(phys_params,num_params;wf_bool=0,cr_bool=0,csm_bool=1)
...
energies_arr4a = GEM2B.GEM_solve(phys_params,num_params;wf_bool=0,cr_bool=1,csm_bool=1)
...
energies_arr4b = GEM2B.GEM_solve(phys_params,num_params;wf_bool=0,cr_bool=1,csm_bool=1)
comparison(real.(energies_arr4b))

#5. check functionality of gaussopt
phys_params = (;hbar=1.0,mur,vint_arr=[v_gauss],lmax=0,lmin=0,dim=3)
println("\nCheck of gaussopt:")
println("\n5a)gaussopt = 0: csm_bool = 0, theta_csm = 0.0")
energies_arr5a = GEM2B.GEM_solve(phys_params,num_params;wf_bool=0,cr_bool=0,csm_bool=0)
comparison(energies_arr5a;gauss_bool=1)
println("\n5b)gaussopt = 1: csm_bool = 0, theta_csm = 0.0")
energies_arr5b = GEM2B.GEM_solve(phys_params,num_params;wf_bool=0,cr_bool=0,csm_bool=0)
comparison(energies_arr5b;gauss_bool=1)
num_params = (;gem_params,omega_cr=0.5,theta_csm=5.0, threshold = 10^-8)
println("\n5c)gaussopt = 0: csm_bool = 1, theta_csm = $(num_params.theta_csm)")
energies_arr5c = GEM2B.GEM_solve(phys_params,num_params;wf_bool=0,cr_bool=0,csm_bool=1)
comparison(energies_arr5c;gauss_bool=1)
println("\n5d)gaussopt = 1: csm_bool = 1, theta_csm = $(num_params.theta_csm)")
energies_arr5d = GEM2B.GEM_solve(phys_params,num_params;wf_bool=0,cr_bool=0,csm_bool=1)
...
nullfun(r) = 0.0
phys_params = (;hbar=1.0,mur,vint_arr=[nullfun],lmax=0,lmin=0,dim=3)
...
energies_arr6a = GEM2B.GEM_solveCC(phys_params, num_params, WCC, DCC; wf_bool=0,cr_bool=0, csm_bool=0, diff_bool=1)
comparison(energies_arr6a;ex_arr=[-1/2,-1/2,-1/8,-1/8,-1/18,-1/18])
println("\ncsm_bool = 1, theta_csm = $(num_params.theta_csm)")
energies_arr6b = GEM2B.GEM_solveCC(phys_params, num_params, WCC, DCC; wf_bool=0, cr_bool=0, csm_bool=1, diff_bool=1)
...
@btime GEM2B.GEM_solve(phys_params,num_params;wf_bool=0,cr_bool=0,csm_bool=0);
print("\ngaussopt = 1, csm_bool = 0: ")
@btime GEM2B.GEM_solve(phys_params,num_params;wf_bool=0,cr_bool=0,csm_bool=0);
print("\ngaussopt = 0, csm_bool = 1: ")
@btime GEM2B.GEM_solve(phys_params,num_params;wf_bool=0,cr_bool=0,csm_bool=1); 
print("\ngaussopt = 0, csm_bool = 1, cr_bool = 1: ")
@btime GEM2B.GEM_solve(phys_params,num_params;wf_bool=0,cr_bool=1,csm_bool=1); 
print("\ngaussopt = 1, csm_bool = 1: ")
@btime GEM2B.GEM_solve(phys_params,num_params;wf_bool=0,cr_bool=0,csm_bool=1); 
print("\ngaussopt = 1, csm_bool = 1, cr_bool = 1: ")
@btime GEM2B.GEM_solve(phys_params,num_params;wf_bool=0,cr_bool=1,csm_bool=1); 
print("\nPreallocation: gaussopt = 0, csm_bool = 0: ")
@btime GEM2B.GEM_solve!(pa,phys_params,num_params,wf_bool,0,0)
print("\nPreallocation: gaussopt = 1, csm_bool = 0: ")
@btime GEM2B.GEM_solve!(pa,phys_params,num_params,wf_bool,0,0)
print("\ncoupled channels(2), csm_bool = 0:")
@btime GEM2B.GEM_solveCC(phys_params, num_params, WCC, DCC; wf_bool=0, cr_bool=0, csm_bool=0, diff_bool=1)
print("\ncoupled channels(2), csm_bool = 1:")
@btime GEM2B.GEM_solveCC(phys_params, num_params, WCC, DCC; wf_bool=0, cr_bool=0, csm_bool=1, diff_bool=1)
end
